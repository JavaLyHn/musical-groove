...
const PRESETS = {
  low:  { grid: 56, stars: 600,  bloom: 0.16, pixelRatio: 1,    fpsCap: 30 },
  mid:  { grid: 72, stars: 900,  bloom: 0.16, pixelRatio: 1.25, fpsCap: 30 },
  high: { grid: 84, stars: 1200, bloom: 0.16, pixelRatio: 1.5,  fpsCap: 60 },
};
