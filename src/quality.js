...
const PRESETS = {
  low:  { grid: 64,  stars: 600,  bloom: 0.13, pixelRatio: 1,    fpsCap: 30 },
  mid:  { grid: 84,  stars: 900,  bloom: 0.13, pixelRatio: 1.25, fpsCap: 30 },
  high: { grid: 100, stars: 1200, bloom: 0.13, pixelRatio: 1.5,  fpsCap: 60 },
};
