    ...
    groups: [
      ...
      },
      {
        id: 'idle', title: '待机', en: 'IDLE', collapsed: true, controls: [
          ...
          { key: 'motion.idleTransition', kind: 'slider', label: '过渡 s', min: 0.1, max: 5, def: 1.0,
          ...
          { key: 'motion.idleHeight', kind: 'slider', label: '待机柱林高度', min: 0, max: 18, def: 9,
          ...
          { key: 'motion.idleRippleStrength', kind: 'slider', label: '待机涟漪强度', min: 0, max: 2, def: 0.85,
